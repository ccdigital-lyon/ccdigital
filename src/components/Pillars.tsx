...
const pillars = [
  {
    icon: "/assets/pillar-mesurer.png",
    title: "Mesurer",
  ...
  {
    icon: "/assets/pillar-decider.png",
    title: "Décider",
  ...
  {
    icon: "/assets/pillar-simuler.png",
    title: "Simuler",
  ...
  {
    icon: "/assets/pillar-verifier.png",
    title: "Vérifier",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-5 gap-6">
          {pillars.map((p, i) => (
            ...
            >
              <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${p.color} flex items-center justify-center shadow-lg overflow-hidden`}>
